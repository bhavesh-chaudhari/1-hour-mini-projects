| Project        | Code   |Tags | Description | Live Demo  |
| ------------- |:-------:| :---:|:---:|:-----:|
...
| `02`  | [Background Gif on Button and Text Glow](https://github.com/bhavesh-chaudhari/1hr_MiniProjects-Components_HTML-CSS-JS/tree/main/Button%201) |*Button 1, Text glow, Gif Background, **tea time***|[Read Here](#background-gif-on-button-and-text-glow)|[Live Demo](https://codepen.io/bhavesh_c/full/QWvbdrB) |
